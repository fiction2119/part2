...
const Countries = (props) => {
  ...
  }, [props.countries]) // Dependency array ensures this effect runs whenever props.countries changes
  ...
  return (
    <div>
      {/*Get Counries that match the filter*/}
      {countries ? (
        <div>
          <h2>Countries</h2>
          <ul>
